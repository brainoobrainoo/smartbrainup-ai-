          ...
          <Container>
            ...
            >
              <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="text-[16px] md:text-[17px] font-normal leading-[1.4] text-white opacity-50 max-w-[480px] mb-10">
            ...
            <div className="text-[16px] md:text-[17px] font-normal leading-[1.15] text-white max-w-[560px] space-y-5">
